  ...
  return (
    <div className="relative">
      <button
        ...
        className="text-light-font-color bg-white focus:ring-0 focus:outline-none font-medium rounded-lg text-md px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:focus:ring-blue-800" type="button">
